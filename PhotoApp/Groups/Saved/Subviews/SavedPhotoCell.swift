...
//  PhotoApp
//
//  Created by Варвара Уткина on 13.10.2025.
//

import UIKit
import SnapKit

final class SavedPhotoCell: UICollectionViewCell {
    static let identifier = "SavedPhotoCell"
    ...
    private func setupViews() {
        ...
        shadowView.addSubviews(imageView, likeStack, saveIcon)
        ...
        shadowView.snp.makeConstraints { make in
            make.edges.equalToSuperview().inset(Drawing.contentInsets)
        }
